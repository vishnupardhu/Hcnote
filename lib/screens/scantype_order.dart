...
class ScanHcTypeOrder extends StatefulWidget {
  const ScanHcTypeOrder({super.key});

  @override
  State<ScanHcTypeOrder> createState() => _ScanHcTypeOrderState();
}

class _ScanHcTypeOrderState extends State<ScanHcTypeOrder> {
